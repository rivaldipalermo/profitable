                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= ($validation->hasError('lokasi_properti')) ? 'is-invalid' : ''; ?>" name="lokasi_properti" placeholder="Lokasi Properti" value="<?= old('lokasi_properti') ?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control <?= ($validation->hasError('deskripsi_properti')) ? 'is-invalid' : ''; ?>" name="deskripsi_properti" rows="4" placeholder="Deskripsi Properti" style="resize: none;"><?= old('deskripsi_properti') ?></textarea>
                            <div class="invalid-feedback">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="d-inline-block me-2 mb-1">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="dokumen_kepemilikan" id="dokumen_kepemilikan" value="SHM">
                                ...
                                <li class="d-inline-block me-2 mb-1">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="dokumen_kepemilikan" id="dokumen_kepemilikan" value="SHGB">
                                        <label class="form-check-label" for="dokumen_kepemilikan">
                                            SHGB
                                        </label>
                                    </div>
                                ...
                                <li class="d-inline-block me-2 mb-1">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="dokumen_kepemilikan" id="dokumen_kepemilikan" value="AJB">
                                        <label class="form-check-label" for="dokumen_kepemilikan">
                                            AJB
                                        </label>
                                    </div>
