                            ...
                            <table class="table table-lg table-striped">
                                ...
                                <tbody>
                                    ...
                                    foreach ($properti as $row) : ?>
                                        ...
                                        <!--Modal -->
                                        <div class="modal fade text-left" id="modal<?= $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <img src="<?= base_url() ?>/assets/images/properti/<?= $row['foto_properti']; ?>" style="width: 250px; height: 250px; border-radius:8px;">
                                                            </div>
                                                            <div class="col-md-3">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="/admin/properti/edit/<?= $row['id']; ?>" class="btn btn-primary ml-1">Edit</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
