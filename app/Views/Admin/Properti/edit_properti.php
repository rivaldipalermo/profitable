...
<section class="section">
  <div class="card">
    <div class="card-body">
      <form action="/admin/properti/update" method="POST" enctype="multipart/form-data">
        <?= csrf_field(); ?>
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input type="hidden" class="form-control" name="provinsi" id="province" value="<?= $properti['provinsi']; ?>">
            </div>
            <div class="form-group">
              ...
              <select class="form-select <?= ($validation->hasError('kabupaten')) ? 'is-invalid' : ''; ?>" id="kabupaten" name="kabupaten">
                <option value="<?= $properti['kabupaten'] ?>"><?= $properti['kabupaten'] ?></option>
              </select>
              <div class="invalid-feedback">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control <?= ($validation->hasError('luas_tanah')) ? 'is-invalid' : ''; ?>" name="luas_tanah" placeholder="Luas Tanah" value="<?= $properti['luas_tanah'] ?>">
              <div class="invalid-feedback">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control <?= ($validation->hasError('luas_bangunan')) ? 'is-invalid' : ''; ?>" name="luas_bangunan" placeholder="Luas Bangunan" value="<?= $properti['luas_bangunan'] ?>">
              <div class="invalid-feedback">
