    ...
    <div class="feature-text">
      ...
      <div class="box9 float-right mr-5 mt-5">
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              <input type="name" class="form-control" id="panggilan" name="panggilan" placeholder="Nama Panggilan"
            ...
            <div class="form-group col-lg-12">
              <input type="name" class="form-control" id="phone" name="phone" placeholder="Nomor Telepon" oninvalid="alert('Silahkan Masukan Nomor Telp');" onkeypress="return hanyaAngka(event)" required>
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
              <input type="name" class="form-control" id="nbank" name="nbank" placeholder="Nama Bank" oninvalid="alert('Silahkan Masukan Nama Bank');" required>
            </div>
            <div class="form-group col-md-6">
              <input type="name" class="form-control" id="cabang" name="cabang" placeholder="Cabang" oninvalid="alert('Silahkan Masukan Cabang');" required>
            </div>
            <div class="form-group col-md-6">
              <input type="name" class="form-control" id="anama" name="anama" placeholder="Atas Nama"  oninvalid="alert('Silahkan Masukan Atas Nama');" required>
            </div>
            <div class="form-group col-md-6">
              <input type="name" class="form-control" id="norek" name="norek" placeholder="Nomor Rekening"  oninvalid="alert('Silahkan Masukan Nomor Rekening');" onkeypress="return hanyaAngka(event)" required>
            </div>
